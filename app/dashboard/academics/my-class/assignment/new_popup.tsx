...
import { CreateAssignment } from "@/actions/academics/assignment/create";
function NewAssignmentPopup({subjectId,topicId,setAssignments}:{subjectId:string,topicId:string,setAssignments:React.Dispatch<SetStateAction<Assignment[]>>}) {
  const [assignmentType, setAssignmentType] = useState<AssType>("OFFLINE");
  ...
  const createAssignment = async () => {
    if (assignmentType === "ONLINE" && !questions.length)
    ...
    if (!dueDate && assignmentType === "ONLINE")
        ...
        <InfinitySpin></InfinitySpin>
          ...
          <div className="flex flex-col gap-4 flex-1 overflow-y-scroll">
            ...
            <Select
              ...
              onValueChange={(e) => setAssignmentType(e as AssType)}
            >
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectLabel>Select Assignment Type</SelectLabel>
