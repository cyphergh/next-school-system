...
function NavBar({loggedIn}:{loggedIn:boolean}) {
  return (
    <div className="flex flex-row justify-between items-center bg-gray-800 text-white  lg:left-[calc(50%-270px)] text-lg w-full bg-opacity-30 lg:w-auto rounded-lg absolute z-50 bottom-2">
